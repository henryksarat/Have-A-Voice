...
namespace UniversityOfMe.Services.Events {
    public interface IEventService {
        ...
        Event GetEvent(UserInformationModel<User> aUser, string aUniversityId, int anEventId);
        ...
        void Attend(UserInformationModel<User> aUser, int anEventId);
        void Unattend(UserInformationModel<User> aUser, int anEventId);
    }
}