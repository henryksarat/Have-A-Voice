    ...
    <div class="col-24 m-btm30">
	    ...
	    <% using (Html.BeginForm()) { %>
	        ...
	        <div class="m-btm10">
                ...
                <%= IssueHelper.IssueInformationDiv(Model.Issue, "push-2 m-lft col-16 m-rgt comment", "col-15 p-v10 options", "col-3 center", "col-3 center", "col-3 center", "col-3 center", "col-3 center", "push-8 col-2 center", "push-8 col-2 center", true, SiteSection.Issue, Model.Issue.Id)%>
