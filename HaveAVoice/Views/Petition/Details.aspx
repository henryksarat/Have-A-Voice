...
<div class="col-24 m-btm30">
    ...
    <div class="b-wht m-btm10">
        ...
        <div class="push-19 alpha col-2">
			<div class="p-a5">
                <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<%= HAVConstants.BASE_URL + LinkHelper.PetitionUrl(Model.Petition) %>" layout="button_count" show_faces="false" width="90" font="arial"></fb:like>
           </div>
           <div class="clear">&nbsp;</div>
        </div>

        <div class="push-18 alpha col-2 m-lft5 center">
			<div class="m-top8">
