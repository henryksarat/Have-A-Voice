...
namespace HaveAVoice.Services.Issues {
    public interface IHAVIssueReplyService {
        ...
        bool CreateIssueReply(IssueModel anIssueModel);
        ...
        IEnumerable<IssueReplyModel> GetReplysToIssue(Issue anIssue, IEnumerable<string> aRoleNames, PersonFilter aFilter);
