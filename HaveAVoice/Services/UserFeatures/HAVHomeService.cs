...
namespace HaveAVoice.Services.UserFeatures {
    public class HAVHomeService : IHAVHomeService {
        ...
        public HAVHomeService(IValidationDictionary aValidationDictionary)
            : this(aValidationDictionary, new HAVIssueService(aValidationDictionary), new FriendService<User, Friend>(new EntityHAVFriendRepository()), new EntityHAVHomeRepository()) { }
