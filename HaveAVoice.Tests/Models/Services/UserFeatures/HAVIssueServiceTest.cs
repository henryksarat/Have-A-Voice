...
namespace HaveAVoice.Tests.Models.Services.UserFeatures {
    ...
    public class HAVIssueServiceTest {
        ...
        public void Initialize() {
            ...
            theIssue = Issue.CreateIssue(ID, ISSUE_TITLE, ISSUE_DESCRIPTION, DateTime.UtcNow, false);
            theIssueReply = IssueReply.CreateIssueReply(ID, REPLY, DateTime.UtcNow, false, 1, false);
        ...
        public void ShouldCreateValidIssue() {
            ...
            Issue issue = Issue.CreateIssue(0, ISSUE_TITLE, ISSUE_DESCRIPTION, ISSUE_POST_DATE, false);
        ...
        public void UnableToCreateCreateIssueBecauseNameIsRequired() {
            Issue issue = Issue.CreateIssue(0, string.Empty, ISSUE_DESCRIPTION, ISSUE_POST_DATE, false);
        ...
        public void UnableToCreateCreateIssueBecauseDescriptionIsRequired() {
            Issue issue = Issue.CreateIssue(0, ISSUE_TITLE, string.Empty, ISSUE_POST_DATE, false);
